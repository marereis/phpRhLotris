...
$curriculo = array();
if (!empty($_SESSION['curriculo']) && $curriculo = $_SESSION['curriculo']) {
...
<html>
    <head>
        <meta charset="UTF-8">
        <link rel="icon" type="image/png" "href= <?= site("root") . "resources/assets/img/logotransp.ico" ?>  />
    ...
    <body onabort="window.open('about:blank')">
        <div class="header">
            <h2><?= $curriculo["NOME"]; //var_dump($curriculo);?></h2>
        </div>
        <br> 
        <div>
           ...
           <p><?= '-' . isset($curriculo["EMPRESA2"]) ? $curriculo["EMPRESA2"] : "";?><br> 
            ...
            <P style="text-align: justify">Procuro sempre levar dinamismo, determinação, disposição para o aprendizado constante e muita vontade de realizar um bom trabalho junto a esta empresa, colaborando para o seu crescimento e consequentemente, realizando-me. Possuo disponibilidade para início imediato.
                Acredito ter o perfil desejado por esta Instituição, apreciaria muito a oportunidade de uma entrevista para melhor esclarecer minhas qualificações profissional. Coloco-me à inteira disposição para posteriores contatos.
                Agradeço antecipadamente a atenção de V.S.ª e aguardo em breve um pronunciamento.</P>

            <br><br>

            <p style="text-align: center">Atenciosamente,</p><br>

            <h3 style="text-align: center"><?= $curriculo["NOME"] ?></h3><br>
